    ...
    def __init__(self):
	    ...
	    if self.forceReload or (len(sys.argv) >= 2 and sys.argv[1] == "reload"):
		    ...
		    # to run after the files are loaded.
                    #self.kern.setBotPredicate(name. robbie)
		    self.kern.bootstrap(learnFiles="/home/robbie/catkin_hydro/src/robbie_chat/nodes/std-startup.xml", commands="load aiml b")
		    self.brainLoaded = True
		    # Now that we've loaded the brain, save it to speed things up for
		    # next time.
		    self.kern.saveBrain("/home/robbie/catkin_hydro/src/robbie_chat/nodes/standard.brn")
	    else:
		    ...
		    try:
			    ...
			    self.kern.bootstrap(brainFile = "/home/robbie/catkin_hydro/src/robbie_chat/nodes/standard.brn")
			    self.brainLoaded = True
		    except:
